...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent"> 
    ...
    <div class="fieldset">        
        <div style="text-align:center; margin-bottom:20px; margin-top:20px; font-size:1.6em;">
        ...
        <asp:Repeater ID="ProductListRepeater" runat="server" DataSourceID="ProductListingDataSource" >
            ...
            <div class="prod">                
                    ...
                    <span class="prodFor">For <span class="prodPrice"> &#8364; <asp:Label CssClass="Price" runat="server" ID="Label4" Text='<%# Eval("price") %>' /></span><br /></span>
