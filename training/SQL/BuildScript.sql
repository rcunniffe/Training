...
use training
GO
CREATE TABLE [maincustaddress]
(	maincustaddressID int IDENTITY(1,1) Primary Key,
	customerID int FOREIGN KEY REFERENCES customers(customerID),
	addressID int FOREIGN KEY REFERENCES custaddress(addressID),
...
(	orderID int IDENTITY(1,1) Primary Key,	
	maincustaddressID int FOREIGN KEY REFERENCES maincustaddress(maincustaddressID),	
    );
GO  
use training
GO
...
(	orderlineID int IDENTITY(1,1) Primary Key,	
	orderID int FOREIGN KEY REFERENCES custorder(orderID),
